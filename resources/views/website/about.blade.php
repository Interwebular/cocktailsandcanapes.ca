            ...
            <div class="clients">
                <div class="client" style="color: #fff;">
                    <div class="quote quote__justified">
                      ...
                      <p>Cocktails & Canapés is Vancouver’s premier catering and event planning company. We specialize in creating distinct culinary experiences, as well as conceptualizing, marketing, and producing memorable events of all sizes. Through our catering services, we aim to provide our clients with creative, world-class cuisine delivered with high quality, professional service.</p>
                       
                      <p>Launched in 2013, Cocktails & Canapés has firmly cemented its reputation in Western Canada as a trendsetter and leader in the catering industry. Our unique brand of customized hospitality experiences and catering services are truly exceptional, immersive, and highly innovative.</p>
                      ...
                      <p>Cocktails & Canapés possess the skills, relationships and expertise needed to make your event unforgettable. From lush garden parties to sidewalk soirees; all-night corporate gatherings to music festivals; intimate romantic weddings to a party for thousands... Cocktails & Canapés is Vancouver’s must-hire catering and event planning company.</p>
        ...
        <div class="flex-right">
          <div id="brett" class="team-descriptions show">
            ...
            <div class="team-descriptions__info">
              ...
              <p class="default">Launching Cocktails and Canapés in 2013, Brett strives to work with local purveyors of produce and has formed strong relationships with suppliers. This allows Cocktails and Canapes to continually build a unique menu of offerings around locally and sustainably sourced foods. Brett’s penchant for attention to detail, event operations experience, sense of culinary creativity, and his passion for food and wine make him a true asset as Owner and Culinary Director of Cocktails & Canapés.</p>
            </div> 
          </div>
          <div id="olivia" class="team-descriptions">
            <h3>Oliva Fobert - Partner, Director of Sales</h3>
            <div class="team-descriptions__info">
              <p class="default">Olivia graduated with a Masters in International Business from the University of Hertfordshire in London. With a focus on Sales and Marketing, Olivia knew that she needed to find a position at a company that she felt passionately about in a bustling industry – and Cocktails & Canapés was just that.</p>
          ...
          <div id="adam" class="team-descriptions">
            ...
            <div class="team-descriptions__info">
              ...
              <p class="default">Now, at the age of 31, Adam is lucky enough to find himself surrounded by a lot of like-minded individuals, where he has taken up the role of Executive Chef at Cocktails and Canapés Catering and Events.</p>
            </div> 
          </div>
