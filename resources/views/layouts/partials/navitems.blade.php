...
<li><a @if(Request::route()->getName() === 'weddings.index') class="active" @endif href="{{ route('weddings.index') }}">Weddings</a></li>
<li><a @if(Request::route()->getName() === 'venues.index') class="active" @endif href="{{ route('venues.index') }}">Event Spaces</a></li>
<li><a @if(Request::route()->getName() === 'blog.index' || Request::route()->getName() === 'blog.post') class="active" @endif href="{{ route('blog.index') }}">News</a></li>
